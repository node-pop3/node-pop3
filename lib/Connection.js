...
var Pop3Connection = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Pop3Connection(_ref) {
    ...
    _this._stream = null;
    _this._command;
    _this.tlsOptions = tlsOptions || {};
    _this.servername = servername || host;
    return _this;
  }
    ...
    value: function connect() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this2.tls) {
          ...
          _this2._socket = _tls2["default"].connect(options);
        } else {
        ...
        _this2._socket.on('data', function (buffer) {
          ...
          var crlfSliceEndIndex = buffer.slice(buffer.length - 2).equals(_constant.CRLF_BUFFER) ? -2 : buffer.length;
          if (buffer[0] === 45) {
            // '-'
            var _err = new Error(buffer.slice(5, crlfSliceEndIndex));
          ...
          if (buffer[0] === 43) {
            // '+'
            var infoBuffer = buffer.slice(4, crlfSliceEndIndex);
