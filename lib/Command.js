...
Object.defineProperty(exports, "stream2String", {
  enumerable: true,
  get: function get() {
    return _helper.stream2String;
  }
});
Object.defineProperty(exports, "listify", {
  enumerable: true,
  get: function get() {
    return _helper.listify;
  }
});
  ...
  _createClass(Pop3Command, [{
      ...
      try {
        ...
        return _await(_this5._connect(), function () {
          return _await(_get(_getPrototypeOf(Pop3Command.prototype), "command", _this5).call(_this5, 'UIDL', msgNumber), function (_ref4) {
            ...
            return _await((0, _helper.stream2String)(stream), _helper.listify);
          });
        });
      } catch (e) {
        return Promise.reject(e);
    ...
    value: function RETR(msgNumber) {
      try {
        ...
        return _await(_this7._connect(), function () {
          return _await(_get(_getPrototypeOf(Pop3Command.prototype), "command", _this7).call(_this7, 'RETR', msgNumber), function (_ref6) {
    ...
    value: function TOP(msgNumber) {
      ...
      try {
        ...
        return _await(_this9._connect(), function () {
          return _await(_get(_getPrototypeOf(Pop3Command.prototype), "command", _this9).call(_this9, 'TOP', msgNumber, n), function (_ref8) {
    ...
    value: function QUIT() {
      try {
        ...
        return _await(_get(_getPrototypeOf(Pop3Command.prototype), "command", _this11).call(_this11, 'QUIT'), function (_ref10) {
