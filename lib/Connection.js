...
var Pop3Connection = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Pop3Connection(_ref) {
    ...
    _this.parseStreamToString = parseStreamToString || true;
    _this._socket = null;
    _this._stream = null;
    _this._command;
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this2._socket.on('data', function (buffer) {
          try {
            ...
            var _err2 = new Error('Unexpected response');
            _err2.eventName = 'try-catch-error';
            reject(_err2);
          }
        });
    ...
    value: function command() {
      try {
        ...
        return _await(new Promise(function (resolve, reject) {
          ...
          _this3.once('error', function (err) {
            return reject(err);
          });
